...
const Footer = () => {
  return (
    <footer className="px-4 pt-12 pb-8 text-white backdrop-blur  border-t border-gray-200">
      <div className="container flex md:flex-col md:justify-between justify-center max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
        <div className="w-full pl-12 mr-4 text-left lg:w-1/4 sm:text-center sm:pl-0 lg:text-left">
          ...
          >
            <span className="flex items-start sm:items-center">
              ...
              <span className="text-black font-bold">BabelLingua</span>
            </span>
          </a>
          <p className="mt-6 mr-4 text-base ">
        ...
        <div className="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0">
          <ul className="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
            ...
            <li>
              <a
                href="#_"
                className="inline-block px-3 py-2  no-underline hover:"
              >
                Features
              </a>
            </li>
          ...
          <div className="flex flex-col w-full text-gray-700">
            ...
            <div className="flex justify-start pl-4 mt-2">
              <a
                className="flex items-center mr-6 no-underline hover:"
                target="_blank"
      ...
      <div className="pt-4 mt-10 text-center text-black  border-t border-gray-100">
        © 2023 BabelLingua. All rights reserved.
      </div>

      <div className="pt-2  mt-2 text-center  border-t border-gray-100">
        Developed By <b>Apu Sutra Dhar</b>
      </div>
    </footer>
  );
};
